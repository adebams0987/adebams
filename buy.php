...
<body>
    ...
    <section class="hero bg-cover bg-center text-white d-flex align-items-center" style="background-image: url('Images/about2.jpg'); background-size: cover; background-position: center; height: 70vh;">
    <div class="container">
